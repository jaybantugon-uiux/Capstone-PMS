    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <div class="d-flex gap-2">
            @if($financialReport->canBeEdited())
                <a href="{{ route('admin.financial-reports.edit', $financialReport) }}" class="btn btn-warning btn-sm">
        ...
        <div class="col-lg-4">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="d-grid gap-2">
                        @if($financialReport->canBeEdited())
                            <a href="{{ route('admin.financial-reports.edit', $financialReport) }}" class="btn btn-warning">
                                <i class="fas fa-edit"></i> Edit Report
                            </a>
                        @endif
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <a href="{{ route('admin.liquidated-forms.show', $financialReport->liquidatedForm) }}" 
