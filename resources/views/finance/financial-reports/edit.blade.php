...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <div class="d-flex gap-2">
            <a href="{{ route('finance.financial-reports.show', $financialReport) }}" class="btn btn-secondary btn-sm">
    ...
    <div class="row">
        <div class="col-lg-8">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('finance.financial-reports.update', $financialReport) }}" method="POST" id="editForm">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title" id="title" class="form-control @error('title') is-invalid @enderror" 
                                           value="{{ old('title', $financialReport->title) }}" required maxlength="255">
                                    @error('title')
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" id="description" rows="3" 
                                      ...
                                      maxlength="1000">{{ old('description', $financialReport->description) }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="notes" id="notes" rows="3" 
                                      ...
                                      maxlength="1000">{{ old('notes', $financialReport->notes) }}</textarea>
                            @error('notes')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <a href="{{ route('finance.financial-reports.show', $financialReport) }}" class="btn btn-secondary">
                ...
                <div class="card-body">
                    ...
                    @if($financialReport->status === 'generated')
                        <div class="alert alert-info">
                            ...
                            <strong>Note:</strong> This report has been generated. 
                            Editing will not affect the calculated totals.
                        </div>
                    @endif
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="alert alert-info mb-3">
                        <i class="fas fa-info-circle"></i>
                        <strong>Note:</strong> You can edit draft and generated reports.
                    </div>
                    
                    <h6 class="font-weight-bold">Report Details:</h6>
                    <ul class="list-unstyled small">
                        <li><i class="fas fa-calendar"></i> Period: {{ $financialReport->formatted_period }}</li>
                        <li><i class="fas fa-money-bill"></i> Currency: {{ $financialReport->currency }}</li>

                        @if($financialReport->project)
                            <li><i class="fas fa-project-diagram"></i> Project: {{ $financialReport->project->name }}</li>
                        @endif
                    </ul>
                </div>
            </div>
