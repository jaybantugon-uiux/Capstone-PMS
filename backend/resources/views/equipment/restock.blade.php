...
<div class="container">
    ...
    <form method="POST" action="{{ route('equipment.restock', $equipment->id) }}">
        @csrf
        <div class="form-group mb-3">
            <label for="amount">Amount to Restock</label>
            <input type="number" name="amount" id="amount" class="form-control @error('amount') is-invalid @enderror" min="1" required>
            @error('amount')
