...
class User extends Authenticatable implements MustVerifyEmail
{
    ...
    public static function determineRole($email)
    {
        ...
        if (str_contains($email, 'main.dru@gmail.com')) {
            return 'admin';
        } elseif (str_contains($email, 'emp.dru@gmail.com')) {
            return 'emp';
        } elseif (str_contains($email, 'finance.dru@gmail.com')) {
            return 'finance';
        } elseif (str_contains($email, 'pm.dru@gmail.com')) {
            return 'pm';
        } elseif (str_contains($email, 'sc.dru@gmail.com')) {
            return 'sc';
        } else {
